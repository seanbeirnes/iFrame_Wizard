...
export function formatAllowList(settingsObject: FormPropsData){
    ...
    const camera_allow_list = settingsObject.allow_camera_text
    ...
    const microphone_allow_list = settingsObject.allow_microphone_text
    ...
    const fullscreen_allowed_list = settingsObject.allow_fullscreen_text
...
export function formatAllowParams(allowFullScreen=false, allowUserMedia=false){
    ...
    allowFullScreen && allowUserMedia ? params += " " : null;
